...
public class FmvFileHandle extends FileHandle<ImportFMVEntity> {
    ...
    @Override
    protected ImportFMVEntity parseLine(String[] cols, int row) throws ParseException {
        int index = 0;

        ImportFMVEntity dto = new ImportFMVEntity();
