...
public class YearConfigurationParameterController extends CommonController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = YearConfigurationParameterListRsrc.class))),
            @ApiResponse(responseCode = "500", description = "Internal Server Error", content = @Content(schema = @Schema(implementation = MessageListRsrc.class)))
    })
    public ResponseEntity<YearConfigurationParameterListRsrc> getAllYearConfigurationParameters() {
