package ca.bc.gov.farms.data.entities.staging;
...
public final class Z29InventoryRef {
    ...
    /**
     * Crop and livestock inventories for market commodities are valued using both
     * an
     * opening price (P1) and a year-end price (P2). Breeding animals and culled
     * breeding
     * animals, which are not considered market commodities, are valued using a
     * yearend
