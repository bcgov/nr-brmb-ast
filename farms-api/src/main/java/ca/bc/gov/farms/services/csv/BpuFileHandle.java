...
public class BpuFileHandle extends FileHandle<ImportBPUEntity> {
    ...
    @Override
    protected ImportBPUEntity parseLine(String[] cols, int row) throws ParseException {
        int index = 0;

        ImportBPUEntity dto = new ImportBPUEntity();
