...
public class FruitVegTypeDetailServiceTest {
    ...
    public void testGetAllFruitVegTypeDetails() {
        ...
        assertThat(resources.getFruitVegTypeDetailList().size()).isEqualTo(1);

        FruitVegTypeDetailModel resource = resources.getFruitVegTypeDetailList().iterator().next();
    ...
    public void testUpdateFruitVegTypeDetail() {
        FruitVegTypeDetailModel resource = null;
        try {
        ...
        FruitVegTypeDetailModel updatedResource = null;
        try {
