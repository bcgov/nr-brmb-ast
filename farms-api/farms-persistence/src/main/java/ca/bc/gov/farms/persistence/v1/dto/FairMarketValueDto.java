...
public class FairMarketValueDto extends BaseDto<FairMarketValueDto> {
    ...
    public boolean equalsAll(FairMarketValueDto other) {
        ...
        if (other != null) {
            ...
            result = result && dtoUtils.equals("period01Price", this, other);
            result = result && dtoUtils.equals("period02Price", this, other);
            result = result && dtoUtils.equals("period03Price", this, other);
            result = result && dtoUtils.equals("period04Price", this, other);
            result = result && dtoUtils.equals("period05Price", this, other);
            result = result && dtoUtils.equals("period06Price", this, other);
            result = result && dtoUtils.equals("period07Price", this, other);
            result = result && dtoUtils.equals("period08Price", this, other);
            result = result && dtoUtils.equals("period09Price", this, other);
            result = result && dtoUtils.equals("period10Price", this, other);
            result = result && dtoUtils.equals("period11Price", this, other);
            result = result && dtoUtils.equals("period12Price", this, other);
            result = result && dtoUtils.equals("period01Variance", this, other);
            result = result && dtoUtils.equals("period02Variance", this, other);
            result = result && dtoUtils.equals("period03Variance", this, other);
            result = result && dtoUtils.equals("period04Variance", this, other);
            result = result && dtoUtils.equals("period05Variance", this, other);
            result = result && dtoUtils.equals("period06Variance", this, other);
            result = result && dtoUtils.equals("period07Variance", this, other);
            result = result && dtoUtils.equals("period08Variance", this, other);
            result = result && dtoUtils.equals("period09Variance", this, other);
