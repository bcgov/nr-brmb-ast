...
public class CodeTableEndpointsImpl extends BaseEndpointsImpl implements
    ...
    public Response getCodeTable(String codeTableName, String effectiveAsOfDate) {
        ...
        try {
            ...
            if (validationMessages.hasMessages()) {
                ...
                CodeTableRsrc result = (CodeTableRsrc) service.getCodeTable(codeTableName,
                        DateUtils.toLocalDate(effectiveAsOfDate), getFactoryContext());
    ...
    public Response updateCodeTable(String codeTableName, CodeTableRsrc updatedCodeTable) {
        ...
        try {
            CodeTableRsrc currentCodeTable = (CodeTableRsrc) this.service.getCodeTable(codeTableName, null,
                    getFactoryContext());
            ...
            if (responseBuilder == null) {
                ...
                CodeTableRsrc result = (CodeTableRsrc) service.updateCodeTable(codeTableName, optimisticLock,
                        updatedCodeTable, getFactoryContext());
