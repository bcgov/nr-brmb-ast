...
@Path("/fruitVegTypeDetails")
@Consumes({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
public interface FruitVegTypeDetailEndpoints {

    @Operation(operationId = "Get all Fruit and Vegetable Type Detail resource.", summary = "Get all Fruit and Vegetable Type Detail resource.", extensions = {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = FruitVegTypeDetailListRsrc.class)), headers = @Header(name = HeaderConstants.ETAG_HEADER, schema = @Schema(implementation = String.class), description = HeaderConstants.ETAG_DESCRIPTION)),
            @ApiResponse(responseCode = "500", description = "Internal Server Error", content = @Content(schema = @Schema(implementation = MessageListRsrc.class))) })
    @GET
    @Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
    public Response getAllFruitVegTypeDetails();

    @Operation(operationId = "Get Fruit and Vegetable Type Detail resource by Id.", summary = "Get Fruit and Vegetable Type Detail resource by Id.", extensions = {
            @Extension(properties = {
                    @ExtensionProperty(name = "auth-type", value = "#{wso2.x-auth-type.app_and_app_user}"),
                    @ExtensionProperty(name = "throttling-tier", value = "Unlimited") }) })
    @Parameters({
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = FruitVegTypeDetailRsrc.class)), headers = @Header(name = HeaderConstants.ETAG_HEADER, schema = @Schema(implementation = String.class), description = HeaderConstants.ETAG_DESCRIPTION)),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Created", content = @Content(schema = @Schema(implementation = FruitVegTypeDetailRsrc.class)), headers = {
    ...
    @Produces({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
    @Consumes({ MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML })
    public Response createFruitVegTypeDetail(
    ...
    @Operation(operationId = "Delete Fruit and Vegetable Type Detail resource.", summary = "Delete Fruit and Vegetable Type Detail resource.", extensions = {
            @Extension(properties = {
                    @ExtensionProperty(name = "auth-type", value = "#{wso2.x-auth-type.app_and_app_user}"),
                    @ExtensionProperty(name = "throttling-tier", value = "Unlimited") }) })
    @Parameters({
