...
public abstract class BaseEndpointsImpl implements BaseEndpoints {
    ...
    protected void logRequest() {
        if (logger.isInfoEnabled()) {
            ...
            Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
            if (authentication != null) {
                logger.info("Authorized User:" + authentication.getPrincipal());
            }
        }
    }
    ...
    protected final static Authentication getAuthentication() {
    ...
    protected URI getBaseUri() {
        ...
        try {
            ...
            boolean unversionedInd = Boolean
                    .parseBoolean(this.applicationProperties.getProperty("base.uri.unversioned", "false"));
                ...
                try {
                    ...
                    try {
                        ...
                        throw new RuntimeException(
                                "Either the parameter is not being validated or the validator mask does not match either '"
                                        + TIMESTAMP_MASK + "': " + value,
                                e2);
                    }
                }
