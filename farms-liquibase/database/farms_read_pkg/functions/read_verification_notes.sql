...
returns table(
    interim_verification_notes      farms.farm_document_templates.template_content%type,
    final_verification_notes        farms.farm_document_templates.template_content%type,
    adjustment_verification_notes   farms.farm_document_templates.template_content%type
)
language sql
as $$
