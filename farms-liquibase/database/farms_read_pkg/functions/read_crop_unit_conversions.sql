...
returns table(
    ...
    default_crop_unit_code              farms.farm_crop_unit_codes.crop_unit_code%type,
    default_crop_unit_code_description  farms.farm_crop_unit_codes.description%type,
    target_crop_unit_code               farms.farm_crop_unit_codes.crop_unit_code%type,
    target_crop_unit_code_description   farms.farm_crop_unit_codes.description%type,
    conversion_factor                   farms.farm_crop_unit_conversn_fctrs.conversion_factor%type
)
language sql
as $$
    with xids as (
