...
declare
    iic_cursor cursor for
        ...
        left outer join farms.farm_inventory_item_codes cd on z.inventory_code::varchar = cd.inventory_item_code
    ...
    icc_cursor cursor for
        select z.inventory_type_code,
               ...
               max(cd.description) old_description
        from farms.farm_z29_inventory_code_refs z
        left outer join farms.farm_inventory_class_codes cd on z.inventory_type_code::varchar = cd.inventory_class_code
    ...
    igc_cursor cursor for
        select z.inventory_group_code,
               ...
               max(cd.description) old_description
        from farms.farm_z29_inventory_code_refs z
        left outer join farms.farm_inventory_group_codes cd on z.inventory_group_code::varchar = cd.inventory_group_code
    ...
    xref_cursor cursor for
        ...
        from farms.farm_z29_inventory_code_refs z
        left outer join farms.farm_agristabilty_cmmdty_xref x on z.inventory_code::varchar = x.inventory_item_code
