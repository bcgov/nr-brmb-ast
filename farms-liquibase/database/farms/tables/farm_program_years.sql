...
COMMENT ON COLUMN farms.farm_program_years.farm_type_code IS E'FARM TYPE CODE is a unique code for the object FARM TYPE CODE. Examples of codes and descriptions are BERRIES - Berries, FORAGE - Forage, GRAIN - Grain.';
