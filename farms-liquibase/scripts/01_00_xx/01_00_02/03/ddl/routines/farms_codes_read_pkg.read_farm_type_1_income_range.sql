create or replace function farms_codes_read_pkg.read_farm_type_1_income_range(
...
begin
    ...
    open cur for
        ...
        where tir.tip_farm_type_1_lookup_id = in_farm_type_1_id
        or tir.tip_farm_type_2_lookup_id = in_farm_type_2_id
