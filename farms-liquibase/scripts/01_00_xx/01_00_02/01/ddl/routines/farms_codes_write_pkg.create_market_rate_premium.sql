create or replace procedure farms_codes_write_pkg.create_market_rate_premium(
   in in_min_total_premium_amount farms.market_rate_premium.min_total_premium_amount%type,
   in in_max_total_premium_amount farms.market_rate_premium.max_total_premium_amount%type,
...
begin
    insert into farms.market_rate_premium (
        ...
        in_min_total_premium_amount,
        in_max_total_premium_amount,
