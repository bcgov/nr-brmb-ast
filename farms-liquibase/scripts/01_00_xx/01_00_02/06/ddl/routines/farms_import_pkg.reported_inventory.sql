...
declare
    ...
    inv_insert_cursor cursor for
        select to_char(z21.inventory_code) inventory_item_code,
               to_char(z21.inventory_type_code) inventory_class_code,
        ...
        left outer join farms.farm_agristabilty_cmmdty_xref x2 on x2.inventory_class_code = to_char(z21.inventory_type_code)
        ...
        union all
        select to_char(aarm.inventory_code) inventory_item_code,
               ...
               coalesce(max(x.agristabilty_cmmdty_xref_id), max(x2.agristabilty_cmmdty_xref_id)) agristabilty_cmmdty_xref_id
        ...
        union all
        select to_char(zz.inventory_code) inventory_item_code,
               to_char(zz.inventory_type_code) inventory_class_code,
        ...
        left outer join farms.farm_agristabilty_cmmdty_xref x2 on x2.inventory_class_code = to_char(zz.inventory_type_code)
                                                             and x2.inventory_item_code = Unknown
