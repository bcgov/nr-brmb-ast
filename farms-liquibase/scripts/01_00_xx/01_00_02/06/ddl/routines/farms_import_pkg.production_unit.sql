    ...
    loop
        ...
        begin
            if pu_val.old_description is null then
                call farms_import_pkg.append_imp1(in_version_id,
                    ...
                    farms_import_pkg.scrub(pu_val.production_unit) || '" action="add">' ||
                ...
                call farms_import_pkg.append_imp1(in_version_id,
                    '<PRODUCTION_UNIT crop_unit_code="' ||
                    farms_import_pkg.scrub(pu_val.production_unit) || '" action="update">' ||
        ...
        exception
            when others then
                ...
                call farms_import_pkg.append_imp1(in_version_id,
                    '<PRODUCTION_UNIT crop_unit_code="' ||
                    farms_import_pkg.scrub(pu_val.production_unit) ||
                    '" action="error"><ERROR>' ||
