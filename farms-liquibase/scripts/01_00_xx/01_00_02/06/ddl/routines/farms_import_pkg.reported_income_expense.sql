...
declare
    ...
    ie_insert_cursor cursor for
        ...
        from farms.farm_z40_prtcpnt_ref_supl_dtls z
        ...
        join farms.farm_farming_operations op on op.program_year_version_id = pyv.in_program_year_version_id
...
begin
    ...
    where li.line_item = to_number(Unknown)
