    ...
    open cur for
        ...
        with scenarios as (
            select m.participant_pin,
                   ...
                   (bct.total_allowable_income + bct.accrual_adjustments_crop_inventory + bct.accrual_adjustments_livestock_inventory + accrual_adjustments_receivables) accrued_allowable_revenue,
