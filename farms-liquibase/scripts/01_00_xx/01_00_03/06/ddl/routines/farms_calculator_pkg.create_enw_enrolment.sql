create or replace procedure farms_calculator_pkg.create_enw_enrolment(
...
begin
    ...
    insert into farms.farm_scenario_enrolments (
        scenario_enrolment_id,
        enrolment_year,
        enrolment_fee,
        contribution_margin,
        benefit_calculated_ind,
        proxy_margins_calculated_ind,
        manual_calculated_ind,
        has_productive_units_ind,
        has_benchmark_per_units_ind,
        benefit_enrolment_fee,
        benefit_contribution_margin,
        proxy_enrolment_fee,
        proxy_contribution_margin,
        manual_enrolment_fee,
        manual_contribution_margin,
        margin_year_minus_2,
        margin_year_minus_3,
        margin_year_minus_4,
        margin_year_minus_5,
        ...
        benefit_margin_year_minus_2,
        benefit_margin_year_minus_3,
        benefit_margin_year_minus_4,
        benefit_margin_year_minus_5,
        benefit_margin_year_minus_6,
        benefit_margn_year_minus_2_ind,
        benefit_margn_year_minus_3_ind,
        benefit_margn_year_minus_4_ind,
        benefit_margn_year_minus_5_ind,
        benefit_margn_year_minus_6_ind,
        proxy_margin_year_minus_2,
        proxy_margin_year_minus_3,
        proxy_margin_year_minus_4,
        manual_margin_year_minus_2,
        manual_margin_year_minus_3,
        manual_margin_year_minus_4,
        combined_farm_percent,
        enrolment_calc_type_code,
        ...
        nextval('farms.farm_se_seq'),
        in_enrolment_year,
        in_enrolment_fee,
        in_contribution_margin,
        in_benefit_calculated_ind,
        in_proxy_margins_calculated_ind,
        in_manual_calculated_ind,
        in_has_productive_units_ind,
        in_has_benchmark_per_units_ind,
        in_benefit_enrolment_fee,
        in_benefit_contribution_margin,
        in_proxy_enrolment_fee,
        in_proxy_contribution_margin,
        in_manual_enrolment_fee,
        in_manual_contribution_margin,
        in_margin_year_minus_2,
        in_margin_year_minus_3,
        in_margin_year_minus_4,
        in_margin_year_minus_5,
        in_margin_year_minus_6,
        in_margin_year_minus_2_ind,
        in_margin_year_minus_3_ind,
        in_margin_year_minus_4_ind,
        in_margin_year_minus_5_ind,
        in_margin_year_minus_6_ind,
        in_benefit_margin_year_minus_2,
        in_benefit_margin_year_minus_3,
        in_benefit_margin_year_minus_4,
        in_benefit_margin_year_minus_5,
        in_benefit_margin_year_minus_6,
        in_benefit_margn_year_minus_2_ind,
        in_benefit_margn_year_minus_3_ind,
        in_benefit_margn_year_minus_4_ind,
        in_benefit_margn_year_minus_5_ind,
        in_benefit_margn_year_minus_6_ind,
        in_proxy_margin_year_minus_2,
        in_proxy_margin_year_minus_3,
        in_proxy_margin_year_minus_4,
        in_manual_margin_year_minus_2,
        in_manual_margin_year_minus_3,
        in_manual_margin_year_minus_4,
        in_combined_farm_percent,
        in_enrolment_calc_type_code,
