...
begin
    ...
    with cur as (
        ...
        select (case
                   when x.agristabilty_commodity_xref_id is not null then z21.inventory_code::varchar
                   else x2.inventory_item_code
               end) inventory_item_code,
               (case
                   when x.agristabilty_commodity_xref_id is not null then z21.inventory_type_code::varchar
        ...
        left outer join farms.agristabilty_commodity_xref x2 on z21.inventory_type_code::varchar = x2.inventory_class_code
                                                             and x2.inventory_item_code = Unknown
        where py.program_year_id = in_program_year_id
    ), aarm as (
        select (case
                   when x.agristabilty_commodity_xref_id is not null then aarm.inventory_code::varchar
                   else x2.inventory_item_code
               end) inventory_item_code,
        ...
        left outer join farms.agristabilty_commodity_xref x2 on aarm.inventory_type_code::varchar = x2.inventory_class_code
                                                             and x2.inventory_item_code = Unknown
        ...
        select (case
                   when x.agristabilty_commodity_xref_id is not null then zz.inventory_code::varchar
                   else x2.inventory_item_code
               end) inventory_item_code,
               (case
                   when x.agristabilty_commodity_xref_id is not null then zz.inventory_type_code::varchar
                   else x2.inventory_class_code
               end) inventory_class_code,
        ...
        left outer join farms.agristabilty_commodity_xref x2 on zz.inventory_type_code::varchar = x2.inventory_class_code
                                                             and x2.inventory_item_code = Unknown
