create or replace function farms_export_pkg.f40(
...
begin
    ...
    open cur for
        ...
        join (
            ...
            left outer join farms.farm_agri_scenarios_mvw m_parent on m_parent.agristability_scenario_id = rf.for_agristability_scenario_id
