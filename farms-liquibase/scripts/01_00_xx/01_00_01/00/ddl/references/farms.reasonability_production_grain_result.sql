ALTER TABLE farms.farm_rsn_prdctn_grain_results ADD CONSTRAINT fk_rpgr_cuc 
    FOREIGN KEY (qty_produced_crop_unit_code)
    REFERENCES farms.farm_crop_unit_codes(crop_unit_code)
;

ALTER TABLE farms.farm_rsn_prdctn_grain_results ADD CONSTRAINT fk_rpgr_iic 
    FOREIGN KEY (inventory_item_code)
    REFERENCES farms.farm_inventory_item_codes(inventory_item_code)
;

ALTER TABLE farms.farm_rsn_prdctn_grain_results ADD CONSTRAINT fk_rpgr_rtr 
