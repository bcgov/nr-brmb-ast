 ...
 * @author awilkinson
 */
public class BenefitTriageZeroTest extends AbstractBenefitTriageTest {
  
  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger(BenefitTriageZeroTest.class);


  @Test
  public void zeroPassReferenceMarginTestPassed() {
  ...
  @Test
  public void zeroPassMarginReferenceTestFailedAtHighEnd() {
    
    Integer participantPin = 23141336;
    Integer programYear = 2022;
    ...
    try {
      ...
      assertNotNull(verifiedTestResults.getMarginTest());
      assertEquals(triageReferenceMarginTestPassed, verifiedTestResults.getMarginTest().getWithinLimitOfReferenceMargin());
      Double verifiedReferenceMarginVariance = verifiedTestResults.getMarginTest().getAdjustedReferenceMarginVariance();
      Double verifiedReferenceMarginVarianceLimit = verifiedTestResults.getMarginTest().getAdjustedReferenceMarginVarianceLimit();
      assertEquals(triageReferenceMarginVariance, verifiedReferenceMarginVariance);
      assertEquals(triageReferenceMarginVarianceLimit, verifiedReferenceMarginVarianceLimit);
  ...
  @Test
  public void zeroPassStructuralChangeTestFailed() {
    
    Integer participantPin = 98765748;
    ...
    try {
      ...
      assertNotNull(verifiedTestResults.getMarginTest());
      assertEquals(triageReferenceMarginTestPassed, verifiedTestResults.getMarginTest().getWithinLimitOfReferenceMargin());
      Double referenceMarginVariance = verifiedTestResults.getMarginTest().getAdjustedReferenceMarginVariance();
      Double referenceMarginVarianceLimit = verifiedTestResults.getMarginTest().getAdjustedReferenceMarginVarianceLimit();
      assertTrue(referenceMarginVariance >= referenceMarginVarianceLimit);
      
      assertNotNull(verifiedTestResults.getStructuralChangeTest());
      assertEquals(triageStructuralChangeTestPassed, verifiedTestResults.getStructuralChangeTest().getResult());
      assertEquals(triageSCAdditiveDivisionTestPassed, verifiedTestResults.getStructuralChangeTest().getWithinAdditiveDivisionLimit());
  ...
  @Test
  public void zeroFailLessThanFiveYearsOfData() {
    
    Integer participantPin = 98765750;
    Integer programYear = 2024;
    ...
    try {
      ...
      assertEquals(Arrays.asList(new String[] {
          MESSAGE_FAIL_LESS_THAN_5_YEARS_OF_DATA
      }), failMessages);
      ...
      assertNotNull(triageScenario.getBenefit().getTotalBenefit());
      assertEquals(0.0, triageScenario.getBenefit().getTotalBenefit());
      assertEquals(4, triageScenario.getReferenceScenarios().size());
  ...
  @Test
  public void zeroFailMarginReferenceTestFailedAtLowEnd() {
    
    Integer participantPin = 98765749;
    Integer programYear = 2024;
    ...
    try {
      ...
      assertEquals(StructuralChangeCodes.RATIO, triageScenario.getBenefit().getExpenseStructuralChangeMethodCode());
      assertNotNull(triageScenario.getBenefit());
      Double triageTotalBenefit = triageScenario.getBenefit().getTotalBenefit();
      assertEquals(Double.valueOf(0), triageTotalBenefit);
      ...
      Double triageReferenceMarginVariance = triageTestResults.getMarginTest().getAdjustedReferenceMarginVariance();
      Double triageReferenceMarginVarianceLimit = triageTestResults.getMarginTest().getAdjustedReferenceMarginVarianceLimit();
      assertTrue(triageReferenceMarginVariance <= (triageReferenceMarginVarianceLimit * -1));
  ...
  @Test
  public void zeroFailFiscalEndDateChanged() {
    
    Integer participantPin = 98765751;
    Integer programYear = 2024;
    ...
    try {
      ...
      
      {
        ...
        FarmingOperation programYearFarmingOperation = triageScenario.getFarmingYear().getFarmingOperations().get(0);
        FarmingOperation previousYearFarmingOperation =
            triageScenario.getReferenceScenarioByYear(previousYear).getFarmingYear().getFarmingOperations().get(0);
        assertNotNull(programYearFarmingOperation);
        assertNotNull(previousYearFarmingOperation);
        
        Date programYearFiscalYearEnd = programYearFarmingOperation.getFiscalYearEnd();
        Date previousYearFiscalYearEnd = previousYearFarmingOperation.getFiscalYearEnd();
        
        assertEquals(DateUtils.getTimestamp(programYear, Calendar.DECEMBER, 31, 0, 0, 0, 0), programYearFiscalYearEnd);
        assertEquals(DateUtils.getTimestamp(previousYear, Calendar.NOVEMBER, 20, 0, 0, 0, 0), previousYearFiscalYearEnd);
      }
  ...
  @Test
  public void zeroFailCombinedFarm() {
    
    Integer participantPin = 22746481;
    Integer programYear = 2022;
    ...
    try {
      ...
      List<ScenarioMetaData> lastYearCombinedFarmScenarios =
          ScenarioUtils.findCombinedFarmScenarios(triageScenario.getScenarioMetaDataList(), lastYear);
      assertNotNull(lastYearCombinedFarmScenarios);
      assertEquals(false, lastYearCombinedFarmScenarios.isEmpty());
