...
<h1>
  ...
  <fmt:message key="Crop"/>
</h1> 
<p></p>

<html:form action="saveCropXref" styleId="codeForm" method="post">
    ...
    <w:ifUserCanPerformAction action="editCodes">
      ...
      <c:if test="${!form.new}">
        <u:yuiButton buttonId="deleteButton" buttonLabel="Delete" formId="codeForm"
           action="deleteCropXref"/>
      </c:if>
      <u:dirtyFormCheck formId="codeForm"/>
    </w:ifUserCanPerformAction>
    <u:yuiButton buttonId="cancelButton" buttonLabel="Cancel" action="farm430"/>
  </div>
