...
//  <c:if test="${form.numCodes > 0}">
      ...
      url = url + "setFilterContext=true" + "&codeFilter=" + codeFilter + "&descriptionFilter=" + descriptionFilter;
//  </c:if>
...
<p><fmt:message key="inventory.item.codes.instruction.text"/></p>

<w:ifUserCanPerformAction action="editCodes">
  <script type="text/javascript">
    //<![CDATA[
    function newButtonFunc() {
      goToUrlPreserveContext('newInventoryItemCode.do');
    }
    //]]>
  </script>
...
//<![CDATA[
  ...
  YAHOO.util.Event.onDOMReady(function() {
    ...
    Farm.showSelectedRow = function(oArgs) {
      ...
      var farmAction = "farm425";  // edit page
