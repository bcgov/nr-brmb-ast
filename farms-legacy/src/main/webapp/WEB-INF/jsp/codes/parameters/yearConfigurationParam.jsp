...
<html:form action="/saveYearConfigParam" styleId="codeForm" method="post">
  ...
  <fieldset style="width:95%">
    <table class="formInput" style="width:100%">
      <tr>
        <th style="width:100px;"><fmt:message key="Program.Year"/>:</th>
        <td>
          <html:hidden property="programYear"/>
          <c:out value="${form.programYear}"/>
        </td>
      </tr>
      <tr>
  ...
  <div style="text-align:right; width:70%;">
    ...
    <u:yuiButton buttonId="cancelButton" buttonLabel="Cancel" action="farm756"/>
  </div>
