...
<script type="text/javascript">
  ...
  function onPageLoad(){
    <c:if test="${form.reportUrl != null}">
      ...
      document.location.href = '<html:rewrite action="backgroundReportView"/>?reportType=REPORT_ANALYTICAL_SURVEILLANCE_STRATEGY';
    </c:if>
  }
...
<html:form action="report655" styleId="report655Form" onsubmit="showProcessing()">
    ...
    <tr>
      ...
      <td>
        <html:select styleId="reportType" property="reportType" onchange="reportChange()">
          ...
          <option value="REPORT_ANALYTICAL_SURVEILLANCE_STRATEGY" selected><fmt:message key="Analytical.Surveillance.Strategy.Report"/></option>
        </html:select>
      </td>
    </tr>
    <tr> 
  ...
  <p></p> 
  <u:yuiButton buttonLabel="Generate.Report" buttonId="generateButton" formId="report655Form"/>
  <p>
    <a href="<html:rewrite action="backgroundReportView"/>?reportType=REPORT_ANALYTICAL_SURVEILLANCE_STRATEGY">
