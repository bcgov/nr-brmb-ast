    ...
    <td valign="top">
      <table class="numeric benefitsummary" style="width: 500px; float: right;">
        ...
        <tr>
          <th>
            <c:out value="${form.nextLineNumber}"/>.
            <fmt:message key="Deemed.Production.Insurance"/>
            <c:if test="${form.benefit.prodInsurDeemedBenefitManuallyCalculated}">
              &times; <fmt:formatNumber type="percent" value="${form.productionInsuranceFactor}"/>
            </c:if>
          </th>
          <td>
            <c:choose>
              ...
              <c:otherwise>
                <fmt:formatNumber type="currency" value="${form.benefit.prodInsurDeemedBenefit}"/>
              </c:otherwise>
            </c:choose>
          </td>
	    ...
	    <td valign="top">
	      <table class="numeric benefitsummary" style="width: 500px; float: right;">
	        ...
	        <tr>
              ...
              <c:out value="${form.nextLineNumber}"/>.
              <fmt:message key="Deemed.Production.Insurance"/>
              <c:if test="${not form.growingForward2024 or form.benefit.prodInsurDeemedBenefitManuallyCalculated}">
                &times; <fmt:formatNumber type="percent" value="${form.productionInsuranceFactor}"/>
              </c:if>
            </th>
	          <td><fmt:formatNumber type="currency" value="${form.benefit.prodInsurDeemedBenefit}"/></td>
