...
<html:form action="export719" styleId="export719Form" onsubmit="showProcessing()">
    ...
    <tr>
      ...
      <td>
        <html:select styleId="exportType" property="exportType" onchange="exportChange()">
          ...
          <option value="AAFMA" selected>Analytical Data Extract</option>
        </html:select>
      </td>
    </tr>
    <tr> 
  ...
  <p></p>
  <u:yuiButton buttonLabel="Generate.Export" buttonId="generateButton" formId="export719Form"/>
