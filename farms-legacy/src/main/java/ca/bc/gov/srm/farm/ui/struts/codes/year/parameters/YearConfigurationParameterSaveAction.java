...
public class YearConfigurationParameterSaveAction extends YearConfigurationParameterAction {
  ...
  protected ActionForward doExecute(
    ...
    logger.debug("Saving Year Configuration Parameter...");
    ...
    if (errors != null && !errors.isEmpty()) {
      ...
      if (checkConfigParamValProvided(form, errorMessages)) {
        ...
        codesService.updateConfigParam(getYearConfigParamFromForm(form), user);
      }
    }    
  ...
  private boolean checkConfigParamValProvided(YearConfigurationParametersForm form, ActionMessages errorMessages) {
