...
public class FruitVegCodeItemViewAction extends FruitVegCodeAction {
  ...
  protected void populateForm(FruitVegCodeForm form) throws Exception {
    ...
    FruitVegTypeCode code = codesService.getFruitVegCode(form.getName());
    
    if (code == null) {
      logger.debug("Could not find the Fruit Veggie Item");
      return;
    }
    ...
    form.setVarianceLimit(code.getVarianceLimit().toString());
