...
/**
 * Object called by a JMX timer to process CHEFS form submissions.
 */
public final class ChefsAgent implements NotificationListener {
  ...
  private static ChefsAgent instance = new ChefsAgent();
   ...
   * @return  ChefsAgent
   */
  public static ChefsAgent getInstance() {
    return instance;
  }
  ...
  private void processSubmissions() {
    ...
    try(Connection connection = openConnection();) {
      try {
        service.processSubmissions(connection);
        connection.commit();
      } catch (Exception ex) {
