...
public interface ChefsSubmissionProcessorService {
  ...
  void createNppSupplementalData(NppSubmissionDataResource data, Integer clientId, Integer programYear,
  ...
  Integer createSupplementalChefsScenario(SupplementalSubmissionDataResource data, Integer clientId, Integer programYear,
