...
public class SectorCodeSaveAction extends SectorCodeAction {
  ...
  protected ActionForward doExecute(
    ...
    logger.debug("Saving Sector Code...");
    ...
    if (errors != null && !errors.isEmpty()) {
      ...
      codesService.updateSectorCode(getSectorCodeFromForm(form), user);
    }    
