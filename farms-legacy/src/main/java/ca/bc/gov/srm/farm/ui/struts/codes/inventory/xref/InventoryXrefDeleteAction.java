 ...
 *
 */
public class InventoryXrefDeleteAction extends InventoryXrefAction {
  ...
  protected ActionForward doExecute(
    ...
    logger.debug("Deleting Inventory Xref...");
    ...
    if (errors != null && !errors.isEmpty()) {
      ...
      try {
        boolean inUse = checkCodeInUse(codesService, form.getCommodityXrefId());
        if(inUse) {
          ...
          codesService.deleteInventoryXref(form.getCommodityXrefId(), form.getRevisionCount());
   ...
   * @throws Exception On Exception
   */
  private boolean checkCodeInUse(CodesService codesService, Integer commodityXrefId)
      throws Exception {
    boolean inUse = codesService.isInventoryXrefInUse(commodityXrefId);
    return inUse;
  }
