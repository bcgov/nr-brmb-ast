...
public class CattleRevenueRiskSubTestResult implements Serializable {
  ...
  public void copy(CattleRevenueRiskSubTestResult o) {
    ...
    hasCattle = o.hasCattle;
    purchases = o.purchases;
    totalSold = o.totalSold;
    totalBirths = o.totalBirths;
