...
/**
 * Used for importing an Ivpr CSV import.
 */
public class IvprDAO extends OracleDAO {
   ...
   */
  public IvprDAO(Connection conn) {
   ...
   * @throws  SQLException  On exception.
   */
  public final void validateStaging(final Integer importVersionId) throws SQLException {
   ...
   * @throws  SQLException  On exception.
   */
  public final void deleteStagingErrors(final Integer importVersionId) throws SQLException {
    final int paramCount = 1;
