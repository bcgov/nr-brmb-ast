 ...
 * @created Nov 12, 2010
 */
public class PayableItem extends InventoryItem {
  
  private static final long serialVersionUID = -1347234193116604045L;
  
  
  public PayableItem() {
    setInventoryClassCode(InventoryClassCodes.PAYABLE);
  }
  ...
  public boolean equals(Object o) {
    ...
    if(o != null && this.getClass().isInstance(o)) {
      PayableItem item = (PayableItem) o;
      result =
