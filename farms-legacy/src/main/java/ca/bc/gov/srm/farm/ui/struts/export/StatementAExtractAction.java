 ...
 */
public class StatementAExtractAction extends SecureAction {
  private Logger logger = LoggerFactory.getLogger(getClass());

  @Override
  public ActionForward doExecute(final ActionMapping mapping, final ActionForm actionForm, final HttpServletRequest request,
    ...
    try {
      ...
      outputFile = service.exportNumberedFilesZip(year, ReportService.REPORT_STA, userAccountName);
   ...
   *           on exception
   */
  private Connection openConnection(final HttpServletRequest request) throws Exception {
